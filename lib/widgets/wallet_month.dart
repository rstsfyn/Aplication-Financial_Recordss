...
class WalletMonth extends StatefulWidget {
  const WalletMonth({super.key});

  @override
  State<WalletMonth> createState() => _WalletMonthState();
}

class _WalletMonthState extends State<WalletMonth> {
  @override
                ...
                GestureDetector(
                  onTap: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const WalletYears()));
                  },
                  child: const Text(
                    'Year',
                    style: TextStyle(fontSize: 16, color: Colors.white),
